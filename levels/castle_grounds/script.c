...
const LevelScript level_castle_grounds_entry[] = {
	...
	AREA(1, castle_grounds_area_1),
		...
		OBJECT(MODEL_NONE, 1106, -232, -3219, 0, 180, 0, 0x000A0000, bhvInstantActiveWarp),
		MARIO_POS(0x01, 180, 1106, -232, -3219),
		...
		OBJECT(MODEL_SSL_PALM_TREE, -4861, -493, -27237, 0, 0, 0, 0x00000000, id_bhvcactus),
		OBJECT(MODEL_NONE, 1106, -312, -3219, 0, 0, 0, (0x0A << 16), bhvInstantActiveWarp),
		OBJECT(MODEL_NONE, 1106, -312, -3219, 0, 0, 0, (0xF0 << 16), bhvInstantActiveWarp),
		OBJECT(MODEL_NONE, 1106, -312, -3219, 0, 0, 0, (0xF1 << 16), bhvInstantActiveWarp),
